...
from applemusic import LOGGER, YouTube, app
from applemusic.misc import db
from applemusic.utils.database import (
    add_active_chat,
...
from applemusic.utils.exceptions import AssistantErr
from applemusic.utils.formatters import check_duration, seconds_to_min, speed_converter
from applemusic.utils.inline.play import stream_markup, telegram_markup
from applemusic.utils.stream.autoclear import auto_clean
from applemusic.utils.thumbnails import gen_thumb
...
async def _clear_(chat_id):
    ...
    try:
        await app.send_message(
            chat_id,
            f"**🎧 ꜱᴏɴɢ ʜᴀꜱ ᴇɴᴅᴇᴅ ɪɴ ᴠᴄ🥺**{text}", # Consider rebranding this message
        )
    except Exception as e:
...
class Call(PyTgCalls):
    def __init__(self):
        self.userbot1 = Client(
            name="applemusicString1", # CHANGED: AppleMusicString1 to applemusicString1
        ...
        self.userbot2 = Client(
            name="applemusicString2", # CHANGED: AppleMusicString2 to applemusicString2
            api_id=config.API_ID,
            api_hash=config.API_HASH,
        ...
        self.userbot3 = Client(
            name="applemusicString3", # CHANGED: AppleMusicString3 to applemusicString3
            api_id=config.API_ID,
            api_hash=config.API_HASH,
        ...
        self.userbot4 = Client(
            name="applemusicString4", # CHANGED: AppleMusicString4 to applemusicString4
            api_id=config.API_ID,
            api_hash=config.API_HASH,
        ...
        self.userbot5 = Client(
            name="applemusicString5", # CHANGED: AppleMusicString5 to applemusicString5
            api_id=config.API_ID,
            api_hash=config.API_HASH,
    ...
    async def join_call(
        ...
        try:
            ...
            try:
                ...
                raise AssistantErr(
                    "**ɴᴏ ᴀᴄᴛɪᴠᴇ ᴠɪᴅᴇᴏ ᴄʜᴀᴛ ғᴏᴜɴᴅ**\n\nᴩʟᴇᴀsᴇ ᴍᴀᴋᴇ sᴜʀᴇ ʏᴏᴜ sᴛᴀʀᴛᴇᴅ ᴛʜᴇ ᴠɪᴅᴇᴏᴄʜᴀᴛ." # Rebranded message
                )
        except Exception as e:
            ...
            raise AssistantErr(
                "**ᴀssɪsᴛᴀɴᴛ ᴀʟʀᴇᴀᴅʏ ɪɴ ᴠɪᴅᴇᴏᴄʜᴀᴛ**\n\nᴍᴜsɪᴄ ʙᴏᴛ sʏsᴛᴇᴍs ᴅᴇᴛᴇᴄᴛᴇᴅ ᴛʜᴀᴛ ᴀssɪᴛᴀɴᴛ ɪs ᴀʟʀᴇᴀᴅʏ ɪɴ ᴛʜᴇ ᴠɪᴅᴇᴏᴄʜᴀᴛ, ɪf ᴛʜɪs ᴩʀᴏʙʟᴇᴍ ᴄᴏɴᴛɪɴᴜᴇs ʀᴇsᴛᴀʀᴛ ᴛʜᴇ ᴠɪᴅᴇᴏᴄʜᴀᴛ ᴀɴᴅ ᴛʀʏ ᴀɢᴀɪɴ." # Rebranded message
            )
        except TelegramServerError:
            raise AssistantErr(
                "**ᴛᴇʟᴇɢʀᴀᴍ sᴇʀᴠᴇʀ ᴇʀʀᴏʀ**\n\nᴩʟᴇᴀsᴇ ᴛᴜʀɴ ᴏғғ ᴀɴᴅ ʀᴇsᴛᴀʀᴛ ᴛʜᴇ ᴠɪᴅᴇᴏᴄʜᴀᴛ ᴀɢᴀɪɴ." # Rebranded message
            )
